...
public class CapsDbHelper {
    ...
    private static final String CREATE_CAPS_FEATURES_TABLE =
            "CREATE TABLE " + DatabaseContract.CapsFeatures.TABLE_NAME + " (" +
                    DatabaseContract.CapsFeatures.FIELD_ID +
                    " INTEGER PRIMARY KEY, " + DatabaseContract.CapsFeatures.FIELD_NODE +
                    " TEXT, " +
    ...
    public static void onCreate(SQLiteDatabase database) {
        ...
        sql += DatabaseContract.CapsFeatures.TABLE_NAME + "_" +
                DatabaseContract.CapsFeatures.FIELD_NODE + "_idx";
        ...
        sql += DatabaseContract.CapsFeatures.TABLE_NAME + "_" +
                DatabaseContract.CapsFeatures.FIELD_FEATURE + "_idx";
        sql += " ON " + DatabaseContract.CapsFeatures.TABLE_NAME + " (";
        ...
        sql = "CREATE INDEX IF NOT EXISTS ";
        sql += DatabaseContract.CapsIdentities.TABLE_NAME + "_" +
                DatabaseContract.CapsFeatures.FIELD_NODE + "_idx";

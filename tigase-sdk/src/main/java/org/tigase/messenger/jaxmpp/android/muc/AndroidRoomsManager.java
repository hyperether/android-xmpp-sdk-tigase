...
public class AndroidRoomsManager
    ...
    protected Room createRoomInstance(BareJID roomJid, String nickname, String password) {
        long roomId = provider
                .createMuc(sessionObject, JID.jidInstance(roomJid), nickname, password);
    ...
    public boolean remove(Room room) {
        Log.i("AndroidRoomsManager",
                "Removing room " + room.getRoomJid() + " (" + room.getId() + ")");

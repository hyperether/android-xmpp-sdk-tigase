...
public final class DatabaseContract {
    ...
    public static abstract class ChatHistory
        ...
        /**
         * Description of values for FIELD_CONTACT_PRESENCE (state) <ul> <li><code>0</code> -
         * incoming</li>
         * <li><code>1</code> - outgoing, sent</li> <li><code>2</code> - incoming unread</li>
         * <li><code>3</code> -
        ...
        /**
         * Description of values for FIELD_ITEM_TYPE (item_type) <ul> <li><code>0</code> -
         * message</li>
         * <li><code>1</code> - locality</li> <li><code>2</code> - file</li> <li><code>3</code> -
         * image</li>
        ...
        public static final String CREATE_TABLE =
                "CREATE TABLE " + TABLE_NAME + " (" + FIELD_ID + " INTEGER PRIMARY KEY, " +
                        FIELD_ACCOUNT + " TEXT, " +
                        FIELD_THREAD_ID + " TEXT, " + FIELD_JID + " TEXT, " + FIELD_AUTHOR_JID +
                        " TEXT, " +
                        FIELD_AUTHOR_NICKNAME + " TEXT, " + FIELD_TIMESTAMP + " DATETIME, " +
                        FIELD_BODY + " TEXT, " +
                        FIELD_ITEM_TYPE + " INTEGER, " + FIELD_CHAT_TYPE + " INTEGER, " +
                        FIELD_DATA + " TEXT, " +
                        FIELD_INTERNAL_CONTENT_URI + " TEXT, " + FIELD_STANZA_ID + " TEXT, " +
                        FIELD_STATE +
                        " INTEGER" + ");";

        public static final String CREATE_INDEX_JID =
                "CREATE INDEX IF NOT EXISTS " + INDEX_JID + " ON " + TABLE_NAME + " (" +
                        FIELD_ACCOUNT + ", " +
                        FIELD_JID + ")";

        public static final String CREATE_INDEX_STATE =
                "CREATE INDEX IF NOT EXISTS " + INDEX_STATE + " ON " + TABLE_NAME + " (" +
                        FIELD_STATE + ")";
    ...
    public static abstract class OpenChats
        ...
        /**
         * <ul> <li><code>0</code> - single user chat</li> <li><code>1</code> - multi user chat</li>
         * </ul>
         */
        public static final String FIELD_TYPE = "type";
    ...
    public static abstract class RosterGroupsCache
        ...
        private static final String CREATE_TABLE =
                "CREATE TABLE " + TABLE_NAME + " (" + FIELD_ID +
    ...
    public static abstract class RosterItemsCache
        ...
        /**
         * Additional field to keep status of buddy from roster item to speed up searches of online
         * users <ul>
         * <li><code>0</code> - unavailable</li> <li><code>1</code> - error</li> <li><code>5</code>
         * - dnd</li>
         * <li><code>10</code> - xa</li> <li><code>15</code> - away</li> <li><code>20</code> -
         * available</li>
        ...
        public static final String CREATE_TABLE =
                "CREATE TABLE " + TABLE_NAME + " (" + FIELD_ID + " INTEGER PRIMARY KEY, " +
                        FIELD_ACCOUNT + " TEXT, " +
                        FIELD_JID + " TEXT, " + FIELD_NAME + " TEXT, " + FIELD_ASK + " BOOLEAN, " +
                        FIELD_SUBSCRIPTION +
    ...
    public static abstract class RosterItemsGroupsCache
        ...
        public static final String TABLE_NAME = "roster_items_groups";
        private static final String CREATE_TABLE =
                "CREATE TABLE " + RosterItemsGroupsCache.TABLE_NAME + " (" +
                        RosterItemsGroupsCache.FIELD_ITEM +
                        " INTEGER, " + RosterItemsGroupsCache.FIELD_GROUP + " INTEGER, " +
                        "FOREIGN KEY(" +
                        RosterItemsGroupsCache.FIELD_ITEM + ") REFERENCES " +
                        RosterItemsCache.TABLE_NAME + "(" +
                        RosterItemsCache.FIELD_ID + ")," + "FOREIGN KEY(" +
                        RosterItemsGroupsCache.FIELD_GROUP +
                        ") REFERENCES " + RosterGroupsCache.TABLE_NAME + "(" +
    ...
    public static abstract class VCardsCache
        ...
        public static final String CREATE_TABLE =
                "CREATE TABLE " + TABLE_NAME + " (" + FIELD_ID + " INTEGER PRIMARY KEY, " +
                        FIELD_JID + " TEXT, " +
                        FIELD_HASH + " TEXT, " + FIELD_DATA + " BLOB, " + FIELD_TIMESTAMP +
                        " DATETIME" + ");";
    ...
    public class Geolocation
        ...
        public static final String CREATE_TABLE =
                "CREATE TABLE " + TABLE_NAME + " (" + FIELD_ID + " INTEGER PRIMARY KEY, " +
                        FIELD_JID + " TEXT, " +
                        FIELD_LON + " REAL, " + FIELD_LAT + " REAL, " + FIELD_ALT + " REAL, " +
                        FIELD_COUNTRY +

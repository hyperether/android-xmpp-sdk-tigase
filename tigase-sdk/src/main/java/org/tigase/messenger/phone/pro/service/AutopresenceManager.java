...
public class AutopresenceManager {
    ...
    void start() {
        ...
        final int defaultPresence = Long.valueOf(sharedPref.getLong("presence", CPresence.ONLINE))
                .intValue();

        Log.d(TAG,
                "Trying to start autopresence: dp=" + defaultPresence + "; delay=" + awayAfterSecs);

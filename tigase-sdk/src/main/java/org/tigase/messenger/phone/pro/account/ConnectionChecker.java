...
public class ConnectionChecker {
    ...
    public ConnectionChecker(String mXmppId, String mPassword, String mHostname) {
        ...
        contact.getEventBus()
                .addHandler(Connector.ErrorHandler.ErrorEvent.class, new Connector.ErrorHandler() {
                    @Override
                    public void onError(SessionObject sessionObject, StreamError condition,
                                        Throwable e)
        ...
        contact.getEventBus()
                .addHandler(AuthModule.AuthFailedHandler.AuthFailedEvent.class,
        ...
        contact.getEventBus()
                .addHandler(
                        InBandRegistrationModule.NotSupportedErrorHandler.NotSupportedErrorEvent.class,
        ...
        contact.getEventBus()
                .addHandler(InBandRegistrationModule.ReceivedErrorHandler.ReceivedErrorEvent.class,
                        new InBandRegistrationModule.ReceivedErrorHandler() {
                            ...
                            @Override
                            public void onReceivedError(SessionObject sessionObject,
                                                        IQ responseStanza,
        ...
        contact.getEventBus()
                .addHandler(JaxmppCore.LoggedInHandler.LoggedInEvent.class,
                        new JaxmppCore.LoggedInHandler() {
                            @Override
        ...
        contact.getEventBus()
                .addHandler(JaxmppCore.LoggedOutHandler.LoggedOutEvent.class,
                        new JaxmppCore.LoggedOutHandler() {
    ...
    public boolean check(Context context) {
        ...
        try {
            ...
            if (contact.getSessionObject().getProperty(SocketConnector.RECONNECTING_KEY) != null &&
                    (Boolean) contact.getSessionObject()
                            .getProperty(SocketConnector.RECONNECTING_KEY)) {
            ...
            Log.d(TAG,
                    "Czy jest error? " + contact.getSessionObject()
                            .getProperty(tigase.jaxmpp.j2se.Jaxmpp.EXCEPTION_KEY) +
                            "  " + (exception == null));

...
public class RosterProvider extends ContentProvider {
    ...
    protected final static int URI_INDICATOR_ROSTER = 2;
    protected final static int URI_INDICATOR_ROSTERITEM_ID = 3;
    protected final static int URI_INDICATOR_ROSTERITEM_JID = 4;
    protected final static int URI_INDICATOR_VCARDITEM_ID = 5;
    protected final static int URI_INDICATOR_VCARDITEM_JID = 6;
    protected final static int URI_INDICATOR_ROSTERITEM_ACCOUNT_JID = 7;
        ...
        switch (sUriMatcher.match(uri)) {
            case URI_INDICATOR_ROSTER:
                cursor = dbHelper.getReadableDatabase()
                        .query(DatabaseContract.RosterItemsCache.TABLE_NAME, projection, selection,
                                selectionArgs, null,
                                null, sortOrder);
                break;
            case URI_INDICATOR_ROSTERITEM_ID:

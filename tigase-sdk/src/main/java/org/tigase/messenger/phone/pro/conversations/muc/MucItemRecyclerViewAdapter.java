...
public class MucItemRecyclerViewAdapter
    ...
    public int getItemViewType(int i) {
        ...
        final int state = getCursor()
                .getInt(getCursor().getColumnIndex(DatabaseContract.ChatHistory.FIELD_STATE));
        final int type = getCursor()
                .getInt(getCursor().getColumnIndex(DatabaseContract.ChatHistory.FIELD_ITEM_TYPE));
        ...
        switch (messageState) {
            ...
            case DatabaseContract.ChatHistory.STATE_INCOMING_UNREAD:
                switch (messageType) {
                    ...
                    case DatabaseContract.ChatHistory.ITEM_TYPE_FILE:
                        viewHolder = new ViewHolderImg(context,
                                LayoutInflater.from(parent.getContext())
                                        .inflate(R.layout.fragment_chatitem_received_image, parent,
                                                false), getFragment());
                        break;
                    default:
                        viewHolder = new ViewHolderMsg(LayoutInflater.from(parent.getContext())
            ...
            case DatabaseContract.ChatHistory.STATE_OUT_SENT:
                switch (messageType) {
                    case DatabaseContract.ChatHistory.ITEM_TYPE_IMAGE:
                        viewHolder = new ViewHolderImg(context,
                                LayoutInflater.from(parent.getContext())
                                        .inflate(R.layout.fragment_groupchatitem_sent_image, parent,
                                                false), getFragment());
                        break;
                    default:
                        viewHolder = new ViewHolderMsg(LayoutInflater.from(parent.getContext())
            ...
            default:
                throw new RuntimeException(
                        "Unknown view type (t=" + messageType + ", s=" + messageState + ")");
        }

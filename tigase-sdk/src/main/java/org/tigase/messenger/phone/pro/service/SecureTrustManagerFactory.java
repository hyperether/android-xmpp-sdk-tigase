...
public class SecureTrustManagerFactory {
    ...
    private SecureTrustManagerFactory() throws KeyStoreException, NoSuchAlgorithmException {
        ...
        Log.d(TAG,
                "Creating Factory with KeyStore type " + ksType + " and TrustManagert algoritm  " +
                        mfAlg);
    ...
    private void init(Context ctx)
        ...
        this.keyStoreFile = new File(
                ctx.getApplicationContext().getDir("TrustStore", Context.MODE_PRIVATE) +
                        File.separator +
                        "TrustStore.bks");
    ...
    public static class DataCertificateException
        ...
        public DataCertificateException(CertificateException e, X509Certificate[] chain,
                                        String authType) {
            super(e);
            this.chain = chain;
    ...
    private class TrustManagerWrapper
        ...
        public void checkClientTrusted(X509Certificate[] chain,
                                       String authType) throws DataCertificateException {
            try {
